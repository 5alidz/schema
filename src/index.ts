...
export type Validator = StringValidator | NumberValidator | BooleanValidator | ArrayValidator | ObjectValidator;
...
export function validateString(validator: StringValidator, value: unknown): string | null {
  if (value == null && validator.optional) {
    ...
    if (validator.minLength && typeof validator.minLength == 'number' && value.length < validator.minLength) {
      return `expected string of length > ${validator.minLength}`;
    }
    if (validator.maxLength && typeof validator.maxLength == 'number' && value.length > validator.maxLength) {
...
export function validateNumber(validator: NumberValidator, value: unknown): string | null {
  if (value == null && validator.optional) {
    ...
    } else if (validator.max && typeof validator.max == 'number' && value > validator.max) {
...
export function validateObject(validator: ObjectValidator, value: unknown): string | string[] | null {
  if (value == null && validator.optional) {
    return null;
